...
const PositiveInsights = lazy(() => import('../dashboard/Analytics/PositiveInsights'));
const KeyPhraseAnalysis = lazy(() => import('../dashboard/TextAnalysis/KeyPhraseAnalysis'));
const AspectAnalysis = lazy(() => import('../dashboard/Analytics/AspectAnalysis'));
const NegativeInsights = lazy(() => import('../dashboard/Analytics/NegativeInsights'));
const TextAnalysis = lazy(() => import('../dashboard/TextAnalysis'));
const BusinessInsights = lazy(() => import('../dashboard/GPTInsights/BusinessInsights'));
...
export default function DashboardContent({ analyticsData, stack, substack, groqToken }: DashboardContentProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 px-4 sm:px-6">
      <Suspense fallback={<div className="h-24 bg-gray-800/50 rounded-xl animate-pulse" />}>
