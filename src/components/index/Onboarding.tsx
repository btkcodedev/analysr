  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-4xl font-bold mb-4 tracking-tight">Tell us about you</h2>
          <p className="text-gray-300 text-lg">Help us customize your analytics experience</p>
        </motion.div>
